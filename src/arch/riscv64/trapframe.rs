...
use core::{arch::asm, ops::{Index, IndexMut}};
...
impl TrapFrame {
    ...
    pub fn new(entry: usize, sp: usize) -> Self {
        ...
        *cx.index_mut(TrapFrameArgs::SP)=sp;
        cx
    }
...
impl Index<TrapFrameArgs> for TrapFrame {
    ...
    fn index(&self, index: TrapFrameArgs) -> &Self::Output {
        match index {
            ...
            TrapFrameArgs::RA => &self.user_x[1],
            TrapFrameArgs::SP => &self.user_x[2],
            TrapFrameArgs::RET => &self.user_x[10],
            TrapFrameArgs::ARG0 => &self.user_x[10],
            TrapFrameArgs::ARG1 => &self.user_x[11],
            TrapFrameArgs::ARG2 => &self.user_x[12],
            TrapFrameArgs::TLS => &self.user_x[4],
            TrapFrameArgs::SYSCALL => &self.user_x[17],
        }
    }
}
...
impl IndexMut<TrapFrameArgs> for TrapFrame {
    fn index_mut(&mut self, index: TrapFrameArgs) -> &mut Self::Output {
        match index {
            ...
            TrapFrameArgs::RA => &mut self.user_x[1],
            TrapFrameArgs::SP => &mut self.user_x[2],
            TrapFrameArgs::RET => &mut self.user_x[10],
            TrapFrameArgs::ARG0 => &mut self.user_x[10],
            TrapFrameArgs::ARG1 => &mut self.user_x[11],
            TrapFrameArgs::ARG2 => &mut self.user_x[12],
            TrapFrameArgs::TLS => &mut self.user_x[4],
            TrapFrameArgs::SYSCALL => &mut self.user_x[17],
        }
    }
}
